...
if(!empty($_POST)){
	...
	$resultJson = getLogin($user, $password);
	...
	if($valid){
		...
		$_SESSION['id'] = $resultJson["results"]['idpublic'];
		$_SESSION['pseudo'] = $resultJson["results"]['pseudo'];
		$_SESSION['mail'] = $resultJson["results"]['mail'];
		$_SESSION['password'] = $resultJson["results"]['password'];
