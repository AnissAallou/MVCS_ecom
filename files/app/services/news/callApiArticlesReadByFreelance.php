...
function articlesReadByFreelance($annee) {
...
curl_setopt($ch, CURLOPT_URL, 'http://localhost:81/API_JSON_PHP/stats/articles/read/byFreelance.php');
...
function articlesReadByFreelanceStats($annee) {
	global $token_security;
...
//Set the URL that you want to GET by using the CURLOPT_URL option.
curl_setopt($ch, CURLOPT_URL, 'http://localhost:81/API_JSON_PHP/stats/articles/read/byFreelanceStats.php');
